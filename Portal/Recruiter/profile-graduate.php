...
include("api-config.php");
	...
	$sql = "INSERT INTO views (user_id,graduate_id) VALUES ('".$_SESSION['user_id']."','".$_GET['id']."')";
	...
	$nviews=0;
	$sql = "select count(*) 'nviews' FROM views where graduate_id='".$_GET['id']."'";
                                            ...
                                            <div class="panel-content image-box">
                                                ...
                                                <div class="font-white image-content">
                                                    <div class="meta-box meta-box-bottom">
														...
														$sql = "SELECT * FROM graduate where graduate_id = '" . $_GET['id'] . "'";
														$result = $conn->query($sql);
                                ...
                                <div class=col-md-8>
                                    <div class=example-box-wrapper>
                                        <ul class="row list-group list-group-icons">
											...
											<li class=col-md-3>
                                                <a href=view-profile.html#tab-example-1 class=list-group-item data-toggle=tab>
                                                <i class="glyph-icon font-blue-alt icon-envelope"></i>
                                                Contact
                                                </a>
                                            </li>
                                        </ul>
										...
										<script type="text/javascript">
											...
											<div class="tab-pane fade" id="tab-example-1">
												<div class=content-box>
                                                    <form class='bordered-row form-horizontal pad15L pad15R' action="api-send-messege.php?recieverType=graduate" method="post">
                                                        <div class='form-group remove-border'>
                                                            <label class='col-sm-3 control-label'><span class='bs-label label-azure'>Name:</span></label>
                                                            <div class=col-sm-6>
                                                                <input class=form-control placeholder='Your Name..' name="contact-name" >
                                                            </div>
                                                        </div>
                                                        <div class=form-group>
                                                            <label class='col-sm-3 control-label'><span class='bs-label label-yellow'>Email:</span></label>
                                                            <div class=col-sm-6>
                                                                <input class=form-control placeholder='Your Email..' name="contact-email" >
                                                            </div>
                                                        </div>
														 <div class="form-group" >
															<label class="col-sm-3 control-label"><span class='bs-label label-purple'>Message:</span></label>
															<div class="col-sm-6">
																<textarea name="contact-message" rows="3" class="form-control textarea-autosize"></textarea>
															</div>
														</div>

														<div class="form-group" >
														 <button class="btn ra-100 btn-azure col-md-3 pull-right" type=submit>Send</button>
														</div>
														<div class="form-group" >	
															<input class=form-control placeholder='' type=hidden name="contact-sender-id" value=<?php echo $_SESSION['user_id'] ?>>
															<input class=form-control placeholder='' type=hidden name="contact-reciver-id" value=<?php echo $_GET['id'] ?> >															
														</div>														
                                                    </form>
                                                </div>
											</div>
                                            ...
                                            <div class="fade tab-pane"id=tab-example-3>
                                                <div class=row>
                                                    ...
                                                    <div class=col-md-9>
														...
														$sql = "SELECT * FROM degree_details where graduate_id = '" . $_GET['id'] . "'";
														$result = $conn->query($sql);
														$count = 1;
														if ($result->num_rows > 0) {
															// output data of each row
														...
														$sql = "SELECT * FROM project_experience where graduate_id = '" . $_GET['id'] . "'";
														$result = $conn->query($sql);
																	...
																	<div class=panel>
                                                                        <div class=panel-heading>
                                                                            <h4 class=panel-title>
																				...
																				<span class='bs-badge badge-azure pull-right' style='margin-left:1.25em'>".$nlikes."</span>
																				
																				<a class='glyph-icon icon-thumbs-up pull-right' href='api-like-project.php?pid=".$row['project_id']."&uid=".$_SESSION['user_id']."'></a>
                                                                            
                                                                            </h4>
                                                                        </div>
                                                                        <div class='collapse panel-collapse' id='collapse".$count."'>
                                                                            <div class=panel-body>
                                                                              of type ".$row["type"]." consequenting to following skills gained ".$row["skill_gained"]."<br><a href='../Graduate/".$row['project_image']."'>Click here to download project file</a>
                                                                            </div>
																			
																			<div class='fileinput-preview thumbnail' data-trigger='fileinput' style='width: 90%; height: 60%; margin-left:1.5em'>Preview: <br><img id='".$row['project_id']."' src='../Graduate/".$row['project_image']."'/></div>
