                                    ...
                                    <div class=panel-layout>
                                        <div class=panel-box>
                                            <div class="panel-content image-box">
                                                <div class=ribbon>
                                                    <div class=bg-primary>Recruiter</div>
                                                </div>
                                                <div class="font-white image-content">
                                                    <div class="meta-box meta-box-bottom">
														...
														$sql = "SELECT * FROM recruiter where recruiter_id = '" . $_GET['id'] . "'";
										...
										<script type="text/javascript">
											...
											<div class="tab-pane fade" id="tab-example-1">
												<div class=content-box>
                                                    <form class='bordered-row form-horizontal pad15L pad15R' action="api-send-messege.php?recieverType=recruiter" method="post">
                                            ...
                                            <div class="fade tab-pane"id=tab-example-3>
                                                <div class=row>
                                                    ...
                                                    <div class=col-md-9>
														...
														$sql = "SELECT * FROM opportunity where recruiter_id = '" . $_GET['id'] . "'";
														$result = $conn->query($sql);
														$count = 1;
														if ($result->num_rows > 0) {
															// output data of each row
																...
																<div class=panel>
                                                                        ...
                                                                        <div class='collapse panel-collapse' id='collapse".$count."'>
                                                                            <div class=panel-body>
                                                                                ".$row["spec"]." holding grade ". $row["grade"].". Empty vacancies are: ".$row["slot"]."
                                                                            </div>
                                                                        </div>
                                                                    </div>
