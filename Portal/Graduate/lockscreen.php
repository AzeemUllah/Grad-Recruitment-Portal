			...
			<div class="center-content row">
				<div class="col-md-4 col-sm-5 col-xs-11 col-lg-3 center-margin ">
					<div class="content-box wow bounceInDown modal-content pad20A clearfix row">
						<div class="col-md-3">
							<img src="../assets/image-resources/profile-picture/graduate/accountID.jpg" alt="" class="img-bordered border-gray radius-all-4 img-full" width="50" height="50">
						</div>
						<div class="col-md-9">
							<div class="meta-box text-left">
								<h3 class="meta-heading font-size-16"><?php echo $_SESSION["graduate_name"] ?></h3>
								<h4 class="meta-subheading font-size-13 font-gray">Graduate User</h4>
